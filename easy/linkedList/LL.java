...
public class LL {
    ...
    public static void printList(Node head,String dataType) {
        Node currNode = head;  //currNode a temporary head var which used to traverse i.e protects our head to modify.
    ...
    public static Node addFirst(String data) {
        ...
        head = newNode; //then initialising newNode at head ref. So, that our new node becomes head node.
        return head;
    }
    ...
    //method overloading for adding a node at end of LinkedList i.e at last position.
