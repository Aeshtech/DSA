...
public class DetectPalindrome {
    ...
    public static boolean isPalindrome(Node head){
        ...
        while (fast != null && fast.next != null){
         ...
         /* fast would become NULL when there are even elements in the list and not NULL for odd elements. We need to skip
            the middle node for odd case and store it somewhere so that we can restore the original list */
