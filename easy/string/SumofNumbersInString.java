...
public class SumofNumbersInString {
    ...
    public static long findSum(String str)
    {
        ...
        for(int i =0 ; i< str.length(); i++){
            ...
            else{               //else parse the temp string into long and add into sum and then assign to sum itself
                sum += Long.parseLong(temp);
                temp = "0";     //reset temp string to '0' again for storing next consecutive numeric values if any.
            }
        }
