...
public class OccurredOnce {
    ...
    public static void occurringOnce(int[] arr) {
        // we have to sorted array for checking the adjacent elements of array are same
        // or different.
        Arrays.sort(arr);
        ...
        // checking if adjacent element are different than simply print else we will not
        // print
